...
public class Destination extends JFrame implements Runnable {
	    ...
	    public Destination() {
	        ...
	        setBounds(400,90, 900, 700);
	        getContentPane().setBackground(new Color(220, 250, 250));
	        
	        th = new Thread(this);

	        
	        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/dest1.jpeg"));
	        ...
	        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icon/dest2.png"));
	        ...
	        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icon/dest3.jpg"));
	        ...
	        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("icon/dest4.jpg"));
	        ...
	        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icon/dest5.jpg"));
	        ...
	        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("icon/dest6.jpg"));
	        ...
	        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("icon/dest7.jpeg"));
	        ...
	        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("icon/dest8.jpg"));
	        ...
	        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("icon/dest9.jpg"));
	        ...
	        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("icon/dest10.jpg"));
