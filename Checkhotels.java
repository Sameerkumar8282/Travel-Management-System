...
public class Checkhotels extends JFrame implements Runnable{
		 ...
		 JLabel l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16, l17, l18, l19;
		    ...
		    public Checkhotels() {
		        ...
		        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("icon/hotel6.jpg"));
		        ...
		        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("icon/hotel7.jpg"));
		        ...
		        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("icon/hotel8.jpg"));
		        ...
		        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("icon/hotel9.jpg"));
		        ...
		        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("icon/hotel10.jpg"));
