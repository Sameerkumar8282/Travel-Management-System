...
public class checkPackage extends JFrame {
	...
	checkPackage(){
		...
		//setLayout(null);
	     ...
	     String[] package3 = new String[]{"BRONZE PACKAGE","6 days and 5 Nights", "Return Airfare", "Free Clubbing, Horse Riding & other Games", "Welcome drinks on Arrival", "Daily Buffet", "Stay in 5 Star Hotel", "BBQ Dinner", "BOOK NOW", "Autumn Special", "Rs 32000 only","package3.jpg"};
	...
	public JPanel createPackage(String[] pack) {
		...
		l6.setBounds(30, 260, 500, 40);
		l6.setForeground(Color.RED);
		l6.setFont(new Font("Tahoma",Font.BOLD,30));
		p1.add(l6);
		
		JLabel l7 = new JLabel(pack[6]);
		l7.setBounds(30, 310, 500, 40);
